...
class AddressDialog {
    ...
    class Builder(context: Context) : BaseDialog.Builder<Builder>(context), Runnable,
        TabAdapter.OnTabListener, RecyclerViewAdapter.OnSelectListener,
        ...
        init {
            setContentView(R.layout.widget_dialog_address)
