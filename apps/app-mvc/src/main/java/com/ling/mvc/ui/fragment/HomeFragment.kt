...
import com.ling.base.FragmentPagerAdapter
...
import com.ling.widget.adapter.TabAdapter
import com.ling.widget.layout.XCollapsingToolbarLayout
 ...
 * desc   : 首页 Fragment
 */
class HomeFragment : TitleBarFragment<HomeActivity>(), XCollapsingToolbarLayout.OnScrimsListener,
    TabAdapter.OnTabListener, ViewPager.OnPageChangeListener {
