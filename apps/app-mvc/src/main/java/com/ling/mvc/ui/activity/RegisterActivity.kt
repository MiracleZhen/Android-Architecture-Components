...
import com.ling.mvc.http.api.RegisterApi
 ...
 * desc   : 注册界面
 */
class RegisterActivity : AppActivity(), TextView.OnEditorActionListener {
    ...
    override fun onClick(view: View) {
        if (view === countdownView) {
            ...
            EasyHttp.post(this)
                ...
                .request(object : HttpCallback<HttpData<RegisterApi.Bean?>>(object : OnHttpListener<Any> {
