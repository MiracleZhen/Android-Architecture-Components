...
import com.ling.gateway.ui.activity.ImageCropActivity
import com.ling.gateway.ui.activity.ImagePreviewActivity
...
import com.ling.http.model.FileContentResolver
import com.ling.mvc.R
import com.ling.mvc.http.api.UpdateImageApi
import com.ling.mvc.http.glide.GlideApp
import com.ling.mvc.http.model.HttpData
import com.ling.widget.dialog.AddressDialog
import com.ling.widget.dialog.InputDialog
import com.ling.widget.layout.SettingBar
import okhttp3.Call
import java.io.File
...
class PersonalDataActivity : AppActivity() {
    ...
    private fun updateCropImage(file: File, deleteFile: Boolean) {
        ...
        EasyHttp.post(this)
            ...
            .request(object : HttpCallback<HttpData<String?>>(object : OnHttpListener<Any> {
