...
import com.ling.http.exception.*
import com.ling.http.request.HttpRequest
import com.ling.mvc.R
import com.ling.mvc.ui.activity.LoginActivity
...
class RequestHandler constructor(private val application: Application) : IRequestHandler {
    ...
    override fun requestSucceed(httpRequest: HttpRequest<*>, response: Response, type: Type): Any {
        ...
        val body: ResponseBody = response.body() ?: throw NullBodyException("The response body is empty")
