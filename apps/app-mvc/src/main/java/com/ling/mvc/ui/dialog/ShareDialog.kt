...
class ShareDialog {
    ...
    class Builder(activity: Activity) : BaseDialog.Builder<Builder>(activity), BaseAdapter.OnItemClickListener {
        ...
        private var listener: UmengShare.OnShareListener? = null
         ...
         * 设置回调监听器
         */
        fun setListener(listener: UmengShare.OnShareListener?): Builder = apply {
        ...
        override fun onItemClick(recyclerView: RecyclerView?, itemView: View?, position: Int) {
            ...
            if (platform != null) {
                if (getContext().packageName.endsWith(".debug") &&
                    (platform === com.ling.umeng.Platform.WECHAT || platform === Platform.CIRCLE)) {
