...
import com.ling.gateway.ui.activity.*
import com.ling.mvc.R
import com.ling.mvc.ui.activity.*
    ...
    override fun onClick(view: View) {
        when (view.id) {
            ...
            R.id.btn_mine_image_select -> {
                ImageSelectActivity.start(getAttachActivity()!!, object : ImageSelectActivity.OnPhotoSelectListener {
            ...
            R.id.btn_mine_video_select -> {
                VideoSelectActivity.start(getAttachActivity()!!, object : VideoSelectActivity.OnVideoSelectListener {
