...
import com.ling.widget.layout.SimpleLayout
import com.ling.widget.view.button.PlayButton
import java.io.File
import java.util.*
...
class PlayerView @JvmOverloads constructor(
    ...
    SeekBar.OnSeekBarChangeListener, View.OnClickListener, ActivityAction, MediaPlayer.OnPreparedListener,
    ...
    fun showController() {
        ...
        topAnimator.addUpdateListener(ValueAnimator.AnimatorUpdateListener { animation: ValueAnimator ->
        ...
        bottomAnimator.addUpdateListener(ValueAnimator.AnimatorUpdateListener { animation: ValueAnimator ->
            val translationY: Int = animation.animatedValue as Int
        ...
        alphaAnimator.addUpdateListener(ValueAnimator.AnimatorUpdateListener { animation: ValueAnimator ->
