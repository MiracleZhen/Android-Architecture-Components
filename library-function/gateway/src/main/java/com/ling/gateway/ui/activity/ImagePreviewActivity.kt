...
import com.ling.gateway.ui.adapter.ImagePreviewAdapter
...
class ImagePreviewActivity : AppActivity(), BaseAdapter.OnItemClickListener {
     ...
     * ViewPager2 页面改变监听器
     */
    private val mPageChangeCallback: ViewPager2.OnPageChangeCallback = object : ViewPager2.OnPageChangeCallback() {
