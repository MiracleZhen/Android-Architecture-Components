...
import com.ling.base.BaseAdapter
...
import com.ling.gateway.ui.adapter.ImageSelectAdapter
import com.ling.gateway.widget.dialog.AlbumDialog
...
import com.ling.widget.recyclerview.GridSpaceDecoration
import com.ling.widget.view.button.FloatActionButton
...
class ImageSelectActivity : AppActivity(), StatusAction, Runnable,
    ...
    override fun onRightClick(titleBar: TitleBar?) {
        ...
        for (key: String in keys) {
            ...
            count += list.size
            data.add(AlbumDialog.AlbumInfo(list[0], key, String.format(getString(R.string.image_select_total), list.size), adapter.getData() === list))
        }
        data.add(0, AlbumDialog.AlbumInfo(allImage[0], getString(R.string.image_select_all),
