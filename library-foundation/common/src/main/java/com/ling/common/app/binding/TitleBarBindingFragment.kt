 ...
 * time   : 2022/5/19
 * desc   : 带标题栏的 Fragment 业务基类 (封装ViewBinding)
 */
abstract class TitleBarBindingFragment<A : AppBindingActivity<*>, VB : ViewBinding> :
    AppBindingFragment<A, VB>(), TitleBarAction {
